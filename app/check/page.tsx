  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-full bg-patient-subtle">
          <ShieldCheck className="size-8 text-patient" aria-hidden="true" />
        </div>
      ...
      {profile && (
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href="/check/history" className="font-medium text-patient hover:underline">
            View or edit it
          </Link>
        </p>
      )}
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        <Card>
          <CardBody className="flex items-start gap-3">
            <ClipboardCheck className="mt-0.5 size-5 shrink-0 text-patient" aria-hidden="true" />
            <div>
        ...
        <Card>
          <CardBody className="flex items-start gap-3">
            <Camera className="mt-0.5 size-5 shrink-0 text-patient" aria-hidden="true" />
            <div>
